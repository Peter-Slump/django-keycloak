    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internal_server_url', models.CharField(help_text='URL on internal netwerk calls. For example when used with Docker Compose. Only supply when internal calls should go to a different url as the end-user will communicate with.', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('realm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='django_keycloak.Realm')),
            ],
        ),
        migrations.AddField(
